                        ...
                        <div class="splide__track">
                            <ul class="splide__list">
                                <li class="splide__slide">
                                    <div class="item item--hero">
                                        ...
                                        <div class="item__cover">
                                            <img src="{{ asset('assets_user/img/covers/cover12.jpg') }}" alt="">
                                        ...
                                        <div class="item__content">
                                            <h3 class="item__title"><a href="details.html">The Edge of Tomorrow</a>
                                            </h3>
                                ...
                                <li class="splide__slide">
                                    <div class="item item--hero">
                                        <div class="item__cover">
                                            <img src="{{ asset('assets_user/img/covers/cover2.jpg') }}" alt="">
                                            <a href="details.html" class="item__play">
                                                <i class="ti ti-player-play-filled"></i>
                                            </a>
                                ...
                                <li class="splide__slide">
                                    <div class="item item--hero">
                                        <div class="item__cover">
                                            <img src="{{ asset('assets_user/img/covers/cover8.jpg') }}" alt="">
                                            <a href="details.html" class="item__play">
                                                <i class="ti ti-player-play-filled"></i>
                                            </a>
                                ...
                                <li class="splide__slide">
                                    <div class="item item--hero">
                                        <div class="item__cover">
                                            <img src="{{ asset('assets_user/img/covers/cover9.jpg') }}" alt="">
                                            <a href="details.html" class="item__play">
                                                <i class="ti ti-player-play-filled"></i>
                                            </a>
                                ...
                                <li class="splide__slide">
                                    <div class="item item--hero">
                                        <div class="item__cover">
                                            <img src="{{ asset('assets_user/img/covers/cover13.jpg') }}" alt="">
                                            <a href="details.html" class="item__play">
                                                <i class="ti ti-player-play-filled"></i>
                                            </a>
                                ...
                                <li class="splide__slide">
                                    <div class="item item--hero">
                                        <div class="item__cover">
                                            <img src="{{ asset('assets_user/img/covers/cover5.jpg') }}" alt="">
                                            <a href="details.html" class="item__play">
                                                <i class="ti ti-player-play-filled"></i>
                                            </a>
                        ...
                        <ul class="nav nav-tabs content__tabs" id="content__tabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button id="2-tab" data-bs-toggle="tab" data-bs-target="#tab-2" type="button"
                                    role="tab" aria-controls="tab-2" aria-selected="false">Movies</button>
                            </li>

                            <li class="nav-item" role="presentation">
                                <button id="3-tab" data-bs-toggle="tab" data-bs-target="#tab-3" type="button"
                                    role="tab" aria-controls="tab-3" aria-selected="false">TV Shows</button>
                            </li>

                            <li class="nav-item" role="presentation">
                                <button id="4-tab" data-bs-toggle="tab" data-bs-target="#tab-4" type="button"
                                    role="tab" aria-controls="tab-4" aria-selected="false">Anime</button>
                            </li>
                        </ul>
                ...
                <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="1-tab"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="item">
                                <div class="item__cover">
                                    <img src="{{ asset('assets_user/img/covers/cover.jpg') }}" alt="">
                                    <a href="details.html" class="item__play">
                                        <i class="ti ti-player-play-filled"></i>
                                    </a>
                                    <span class="item__rate item__rate--green">8.4</span>
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="item">
                                <div class="item__cover">
                                    <img src="{{ asset('assets_user/img/covers/cover3.jpg') }}" alt="">
                                    <a href="details.html" class="item__play">
                                        <i class="ti ti-player-play-filled"></i>
                                    </a>
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="item">
                                <div class="item__cover">
                                    <img src="{{ asset('assets_user/img/covers/cover4.jpg') }}" alt="">
                                    <a href="details.html" class="item__play">
                                        <i class="ti ti-player-play-filled"></i>
                                    </a>
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="item">
                                <div class="item__cover">
                                    <img src="{{ asset('assets_user/img/covers/cover6.jpg') }}" alt="">
                                    <a href="details.html" class="item__play">
                                        <i class="ti ti-player-play-filled"></i>
                                    </a>
                                    <span class="item__rate item__rate--green">7.1</span>
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="item">
                                <div class="item__cover">
                                    <img src="{{ asset('assets_user/img/covers/cover7.jpg') }}" alt="">
                                    <a href="details.html" class="item__play">
                                        <i class="ti ti-player-play-filled"></i>
                                    </a>
                                    <span class="item__rate item__rate--green">7.1</span>
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="item">
                                <div class="item__cover">
                                    <img src="{{ asset('assets_user/img/covers/cover10.jpg') }}" alt="">
                                    <a href="details.html" class="item__play">
                                        <i class="ti ti-player-play-filled"></i>
                                    </a>
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="item">
                                <div class="item__cover">
                                    <img src="{{ asset('assets_user/img/covers/cover11.jpg') }}" alt="">
                                    <a href="details.html" class="item__play">
                                        <i class="ti ti-player-play-filled"></i>
                                    </a>
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="item">
                                <div class="item__cover">
                                    <img src="{{ asset('assets_user/img/covers/cover14.jpg') }}" alt="">
                                    <a href="details.html" class="item__play">
                                        <i class="ti ti-player-play-filled"></i>
                                    </a>
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="item">
                                <div class="item__cover">
                                    <img src="{{ asset('assets_user/img/covers/cover15.jpg') }}" alt="">
                                    <a href="details.html" class="item__play">
                                        <i class="ti ti-player-play-filled"></i>
                                    </a>
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="item">
                                <div class="item__cover">
                                    <img src="{{ asset('assets_user/img/covers/cover16.jpg') }}" alt="">
                                    <a href="details.html" class="item__play">
                                        <i class="ti ti-player-play-filled"></i>
                                    </a>
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="item">
                                <div class="item__cover">
                                    <img src="{{ asset('assets_user/img/covers/cover17.jpg') }}" alt="">
                                    <a href="details.html" class="item__play">
                                        <i class="ti ti-player-play-filled"></i>
                                    </a>
                                    <span class="item__rate item__rate--green">8.0</span>
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="item">
                                <div class="item__cover">
                                    <img src="{{ asset('assets_user/img/covers/cover18.jpg') }}" alt="">
                                    <a href="details.html" class="item__play">
                                        <i class="ti ti-player-play-filled"></i>
                                    </a>
                                    <span class="item__rate item__rate--green">7.1</span>
                        ...
                        <div class="splide__track">
                            <ul class="splide__list">
                                ...
                                <li class="splide__slide">
                                    <div class="item item--carousel">
                                        <div class="item__cover">
                                            <img src="{{ asset('assets_user/img/covers/cover10.jpg') }}"
                                                alt="">
                                            <a href="details.html" class="item__play">
                                                <i class="ti ti-player-play-filled"></i>
                                            </a>
                                ...
                                <li class="splide__slide">
                                    <div class="item item--carousel">
                                        <div class="item__cover">
                                            <img src="{{ asset('assets_user/img/covers/cover11.jpg') }}"
                                                alt="">
                                            <a href="details.html" class="item__play">
                                                <i class="ti ti-player-play-filled"></i>
                                            </a>
                                ...
                                <li class="splide__slide">
                                    <div class="item item--carousel">
                                        <div class="item__cover">
                                            <img src="{{ asset('assets_user/img/covers/cover12.jpg') }}"
                                                alt="">
                                            <a href="details.html" class="item__play">
                                                <i class="ti ti-player-play-filled"></i>
                                            </a>
