            ...
            <div class="row">
				...
				<div class="col-12">
                    <div class="main__title">
						...
						<div class="main__title-wrap">
                            <button type="button" data-bs-toggle="modal" class="main__title-link main__title-link--wrap" data-bs-target="#addCountrie">Add countrie</button>
								...
								<tr>
									...
									<td>
										<div class="catalog__btns d-flex justify-content-center">
											<button data-id="{{$value->id}}" class="catalog__btn catalog__btn--edit" data-bs-toggle="modal"  data-bs-target="#modalEdit">
												<i class="ti ti-edit"></i>
											</button>
											<button data-id="{{$value->id}}" type="button" data-bs-toggle="modal" class="catalog__btn catalog__btn--delete" data-bs-target="#modalDelete">
                ...
                <div class="col-12">
                    <div class="main__paginator">
                        <span class="main__paginator-pages">{{ $listCountrie->currentPage() }} of {{ $listCountrie->lastPage() }}</span>
                        ...
                        <ul class="paginator">
                            ...
                            @for ($i = 1; $i <= $listCountrie->lastPage(); $i++)
                                <li class="paginator__item {{ $i === $listCountrie->currentPage() ? 'paginator__item--active' : '' }}">
				...
				<div class="modal__content">
					...
					<form action="" class="modal__form" id="ConfirmDelete" method="post">
						...
						<div class="modal__btns">
							<button class="modal__btn modal__btn--dismiss" type="button" data-bs-dismiss="modal" aria-label="Close"><span>Close</span></button>
