{{-- <span>Click here to<a href="{{route('resetPass', $token)}}">Reset Password</a></span> --}}
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <div>
                                                                <h2 style="text-align: center;">Hello! We are FilmFlex
                                                                </h2>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            ...
                                                            <h1 class="v-font-size"
                                                                ...
                                                                <span><span>We received a request to reset your
                                                                        password. If you did not make this request, you
                                                                        can safely ignore this email. <br />To reset
                                                                        your password, please press the button
                                                                        below.<br /></span></span>
                                                                <p>For security reasons, this token will expire in
                                                                    <strong>15 minute</strong>. <br />If you have any
                                                                    questions or need further assistance, please don't
                                        ...
                                        <div
                                            ...
                                            <table style="font-family:'Raleway',sans-serif;" role="presentation"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="v-container-padding-padding"
                                                            style="overflow-wrap:break-word;word-break:break-word;padding:14px;font-family:'Raleway',sans-serif;"
                                                            align="left">
                                                            ...
                                                            <div align="center">
                                                                <div style="display: table; max-width:244px;">
                                                                    ...
                                                                    <!--[if (mso)|(IE)]><td width="37" style="width:37px; padding-right: 12px;" valign="top"><![endif]-->
                                                                    <table align="center" border="0"
                                                                        cellspacing="0" cellpadding="0"
                                                                        width="37" height="37"
                                                                        style="width: 37px !important;height: 37px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 12px">
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="center" valign="middle"
                                                                                    ...
                                                                                    <a href="https://facebook.com/"
                                                                                        ...
                                                                                        <img src="images/image-2.png"
                                                                                            ...
                                                                                            title="Facebook"
                                                                                            width="37"
                                                                                            style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;max-width: 37px !important">
                                                                                    </a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    ...
                                                                    <!--[if (mso)|(IE)]><td width="37" style="width:37px; padding-right: 0px;" valign="top"><![endif]-->
                                                                    <table align="center" border="0"
                                                                        cellspacing="0" cellpadding="0"
                                                                        width="37" height="37"
                                                                        style="width: 37px !important;height: 37px !important;display: inline-block;border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;margin-right: 0px">
                                                                        <tbody>
                                                                            <tr style="vertical-align: top">
                                                                                <td align="center" valign="middle"
                                                                                    style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
